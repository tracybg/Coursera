...
class SolitaireMancala:
    ...
    def is_game_won(self):
        ...
        """
        seed_count = 0
        for dummy_house_num in range(1, len(self._board)):
            seed_count += self.get_num_seeds(dummy_house_num)
    ...
    def apply_move(self, house_num):
        ...
        if self.is_legal_move(house_num):
            for dummy_house_num in range(house_num):        
                self._board[dummy_house_num] += 1
    ...
    def choose_move(self):
        ...
        for dummy_house_num in range(1, len(self._board)):
            if self.is_legal_move(dummy_house_num):
                return dummy_house_num    
